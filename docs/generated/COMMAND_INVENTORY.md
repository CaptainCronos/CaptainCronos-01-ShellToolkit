...
| cc helpme-refresh | 1.0.0-alpha1 | Patch installed helpme output for Phase 2 command architecture. |
| cc install | reads VERSION | Install the Shell Toolkit locally. |
...
| cc system-update | 1.0.0-alpha1 | Run OS, package, app, and CLI Safe Boot update workflow. |
| cc toolkit-update | reads VERSION | Pull latest toolkit changes and reinstall local command files. |
| cc update | 2.0.0-alpha1 | Run managed toolkit and system maintenance workflow. |
| cc verify | reads VERSION | Verify repository structure and Bash syntax. |
