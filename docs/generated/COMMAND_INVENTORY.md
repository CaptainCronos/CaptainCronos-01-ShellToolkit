...
|---|---|---|---|
| cc about | flat-no-switches | 1.3.0 | Show toolkit overview and documentation locations. |
| cc asset | namespace | 1.3.0 | Manage local lifecycle asset inventory records. |
| cc audit | namespace-with-switches | 1.3.0 | Run command consistency checks across toolkit commands. |
| cc baseline | flat-no-switches | 1.3.0 | Capture operating-system baseline shell files. |
...
| cc dev-update | flat-with-switches | 1.3.0 | Report and explicitly update developer package managers. |
| cc docs | namespace-with-switches | 1.3.0 | Generate toolkit documentation and command references. |
| cc doctor | flat-with-switches | 1.3.0 | Run repository, installation, and host health checks. |
| cc drive-burnin | namespace | 1.3.0 | Framework for drive acceptance workflow. |
| cc drive-inventory | namespace | 1.3.0 | Show physical drive inventory with identity and SMART basics. |
| cc drive-qualify | namespace-with-switches | 1.3.0 | Run non-destructive drive qualification workflow. |
| cc drive-report | flat-no-switches | 1.3.0 | Save SMART reports and update drive asset records. |
| cc drive-smart | flat-no-switches | 1.3.0 | Show a concise SMART summary for one storage device. |
| cc drive-test | namespace | 1.3.0 | Start or inspect SMART self-tests for one storage device. |
| cc drives | flat-no-switches | 1.3.0 | Show installed storage devices and mount information. |
...
| cc kernel-cleanup | compatibility-wrapper | 1.3.0 | Compatibility entry point for safe kernel cleanup review. |
| cc maintenance | namespace-with-switches | 1.3.0 | Inspect persistent toolkit resource ownership and retention. |
...
| cc prompt | interactive | 1.3.0 | Run dynamic Prompt Engine templates. |
| cc registry | namespace | 1.3.0 | Display command metadata registry information. |
| cc release | namespace-with-switches | 1.3.0 | Plan and run the toolkit release workflow. |
| cc repo | flat-no-switches | 1.3.0 | Show the toolkit repository path and Git remote information. |
| cc reports | namespace-with-switches | 1.3.0 | Inspect and conservatively prune persistent report history. |
...
| cc verify | namespace-with-switches | 1.3.0 | Verify repository structure, Bash syntax, and command permissions. |
| cc version | flat-no-switches | 1.3.0 | Show toolkit version information. |
| cc workbench | namespace-with-switches | 1.3.0 | Prepare a live USB drive qualification workbench environment. |
